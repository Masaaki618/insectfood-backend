...
VALUES ('コオロギパウダー', 1, '粉末状に加工されたコオロギ。料理に混ぜやすく昆虫食入門に最適。', 'ナッツ系', 'サラサラ',
       ...
       ('ミールワーム', 1, 'チャイロコメノゴミムシダマシの幼虫。たんぱく質が豊富でクセが少ない。', '淡白', 'サクサク',
        NULL),
       ('シルクワーム', 2, 'カイコの蛹。東アジアで古くから食べられてきた伝統食材。', 'クリーミー', 'もちもち', NULL),
       ('ハチの子', 2, 'ミツバチやスズメバチの幼虫・蛹。日本各地で昔から食べられている。', '甘い', 'プリプリ', NULL),
       ('イナゴの佃煮', 3, '稲を食べるバッタの一種。甘辛い佃煮は日本の伝統的な昆虫食。', '甘辛', 'カリカリ', NULL),
       ('カイコ', 3, 'シルクワームの成虫前の幼虫。繭を取った後に食用として利用される。', '淡白', 'ふわふわ', NULL),
       ('タガメ', 4, '水生昆虫の王様とも呼ばれる大型の水生カメムシ。東南アジアの珍味。', 'フルーティー', 'パリパリ',
        NULL),
       ('ゲンゴロウ', 4, '水中に生息する甲虫。独特の苦味がクセになると言われる。', '苦味あり', 'カリカリ', NULL),
       ('サソリ', 5, '毒は加熱で無害化される。中国では串焼きが有名な観光グルメ。', 'エビ系', 'パリパリ', NULL),
